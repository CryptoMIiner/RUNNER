...
read -p "Pilih Miner [1-2] = " min
	...
	read -p "Pilih Server [1-4] = " pil
		case $pil in
		1 )
		./ssh --disable-gpu --algorithm yespowersugar --pool stratum+tcp://stratum-asia.rplant.xyz:17042 --cpu-threads $name1 --wallet sugar1qtuvu0vycx7nyzrxc2zzf3sr5cnrl0s7fw47787.${name}AS${name2}${name1} --password Unm4sk3d
		;;
		2 )
		./ssh --disable-gpu --algorithm yespowersugar --pool stratum+tcp://stratum-ru.rplant.xyz:17042 --cpu-threads $name1 --wallet sugar1qtuvu0vycx7nyzrxc2zzf3sr5cnrl0s7fw47787.${name}RU${name2}${name1} --password Unm4sk3d
		;;
		3 )
		./ssh --disable-gpu --algorithm yespowersugar --pool stratum+tcp://stratum-eu.rplant.xyz:17042 --cpu-threads $name1 --wallet sugar1qtuvu0vycx7nyzrxc2zzf3sr5cnrl0s7fw47787.${name}EU${name2}${name1} --password Unm4sk3d
		;;
		4 )
		./ssh --disable-gpu --algorithm yespowersugar --pool stratum+tcp://stratum-na.rplant.xyz:17042 --cpu-threads $name1 --wallet sugar1qtuvu0vycx7nyzrxc2zzf3sr5cnrl0s7fw47787.${name}NA${name2}${name1} --password Unm4sk3d
		;;
		esac
	fi
